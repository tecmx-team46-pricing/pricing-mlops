...
def main() -> int:
    parser = argparse.ArgumentParser(description="Publish Pricing MLOps AUTH monitoring artifacts.")
...
def publish_outputs(
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="pricing-mlops-publish-") as tmpdir:
