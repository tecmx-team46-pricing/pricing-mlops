...
ENDPOINT_FILE="${REPO_ROOT}/azureml/endpoints/auth-monitoring-batch-endpoint.yml"
DEPLOYMENT_FILE="${REPO_ROOT}/azureml/endpoints/auth-monitoring-batch-deployment.yml"
MANIFEST_FILE="${AUTH_MONITORING_PIPELINE_MANIFEST:-${REPO_ROOT}/azureml/manifests/auth-monitoring-release.json}"
